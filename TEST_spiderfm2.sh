...
#datasets=(MultiFoV RobotcarNight RobotcarSeason RobotcarWeather ETH3DI ETH3DO)
#Weather)
...
for ds in "${datasets[@]}"; do
    python test.py --gpus 8 --weight mast3r-spider --version 100h --test --batch_size 1 \
        --tests $ds \
        --DATA_ROOT /cis/home/zshao14/datasets/zeb \
        --outdir_name ms-mast3r-spider-concat-512-1600 \
        --img_size 512 \
        --fine_size 1600
done
python analysis.py --dir dump/zeb/ms-mast3r-spider-concat-512-1600 --wid mast3r-spider --version 100h --verbose
